...
# CS 143 Artificial Intelligence Assignment #9
# author: (Johnny Hill)
# proposed points: X (10 of 10)  -- not changing this line automatically results a 1 point deduction
# Sources: In class, http://aima.cs.berkeley.edu/python/csp.py, Alex Rodgers, Christian Phillips
